...
var first3 = "qwerty" && 5 
console.log(first3);  // the last value is displayed
...
console.log(first17); // if all were true, returns the last operand. That's why it's true
var first18 = false && (false || true); 
console.log(first18);  //if all were false, false is returned
